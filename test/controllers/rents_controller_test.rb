...
class RentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post rents_url, params: { rent: { address: @rent.address, age: @rent.age, name: @rent.name, price: @rent.price, remarks: @rent.remarks } }
    end
  ...
  test "should update rent" do
    patch rent_url(@rent), params: { rent: { address: @rent.address, age: @rent.age, name: @rent.name, price: @rent.price, remarks: @rent.remarks } }
